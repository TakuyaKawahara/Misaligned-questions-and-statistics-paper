...
max(b2$tpi111)
d1 <- ggplot(data=b2, aes(tsde0, dif)) + 
  geom_point() +
#  geom_abline(slope=1, intercept=0) +
  ...
  theme_bw() +
  xlab(" ") +
  ylab(expression(paste(CDE[0] - SDE[0]^{a[D]== 0}))) +
  theme(
...
max(b2$tpi111)
d2 <- ggplot(data=b2, aes(tsde0, dif)) + 
  geom_point() +
#  geom_abline(slope=1, intercept=0) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
...
max(b2$tpi110)
d3 <- ggplot(data=b2, aes(tsde0, dif)) + 
  geom_point() +
  #  geom_abline(slope=1, intercept=0) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
  theme_bw() +
  xlab(expression(paste(SDE[0]^{a[D]== 0}))) +
  ylab(expression(paste(CDE[0] - SDE[0]^{a[D]== 0}))) +
  theme(
    plot.title = element_text(size=20),
    axis.title = element_text(size=21),
...
max(b2$tpi111)
d4 <- ggplot(data=b2, aes(tsde0, dif)) + 
  geom_point() +
#  geom_abline(slope=1, intercept=0) +
  geom_vline(xintercept = 0) +
  geom_hline(yintercept = 0) +
...
ggsave(paste("figures/InterpretationalError_sde0", format_day, ".png", sep=""), dpi=300, width = 27, height = 27, units = "cm")
