...
param <- data.frame(theta_0=-1, theta_1=-2, theta_2=1, theta_3=3, theta_4=1, theta_5=-2, theta_6=0,
                    beta_0=-3, beta_1=1, beta_2=7, beta_3=-1, beta_4=3, beta_5=1, beta_6=0, pL=0.1, pU=0.5, phi_0=0, phi_1=0)
filename <- 6
slots <- 4
